...
namespace shoppingAPP_day3.Models
{
    public class ProductsModel
    {
        ...
        private static List<ProductsModel> _productsList = new List<ProductsModel>()
        {
            ...
            new ProductsModel { pId = 7, pName = "Jeep Compass", pCategory = "SUV", pIsInStock = true, pPrice = 2800000 },
            new ProductsModel { pId = 7, pName = "Puma Sports TShirt", pCategory = "TShirt", pIsInStock = true, pPrice = 2800000 },
            new ProductsModel { pId = 7, pName = "GAP", pCategory = "TShirt", pIsInStock = true, pPrice = 2800000 },
        };
        ...
        //public List<string> GetUniqueProductCategory()
        //{
        //   var categories = (from p in _productsList
        //                    select p).Distinct(c => c.pCategory);
